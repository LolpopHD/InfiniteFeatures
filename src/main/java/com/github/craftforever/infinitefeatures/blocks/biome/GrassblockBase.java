...
public class GrassblockBase extends Block implements IGrowable, IHasModel
{
	
	public Block dirt;
	public Plant plant;

	public GrassblockBase(Plant plant, Block dirt) 
	{
		super(Material.GRASS);
		this.dirt = dirt;
		this.plant = plant;
		setTranslationKey(plant.name+"_grass");
		setRegistryName(plant.name+"_grass");
